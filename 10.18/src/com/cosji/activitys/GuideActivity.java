...
LayoutInflater inlfater;
	...
	public void initProPageView() {
		 ...
		 Intent intent = getIntent();
				...
				imageResId = new int[] { R.drawable.tab1, R.drawable.tab2,
						R.drawable.tab3 };
		...
		inlfater=LayoutInflater.from(GuideActivity.this);
	 View v=inlfater.inflate(R.layout.guide_item,null);
	 imageViews.add(v);
	 v.findViewById(R.id.close_guide).setOnClickListener(new OnClickListener() {
		...
		public void onClick(View arg0) {
			// TODO Auto-generated method stub
			Intent in=new Intent(GuideActivity.this,MainTabActivity.class);
			startActivity(in);
			finish();
		}
	});
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		MobclickAgent.onPause(GuideActivity.this);
	}
}
