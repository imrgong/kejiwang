...
public class OtherGoodsDetilsActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.othergoodsdetials);
	...
	private void initViews() {
		...
		details_image = (ImageView)findViewById(R.id.other_detial_image);
		...
		public void onClick(View v) {
			...
			case R.id.goto_shopping_now:
				...
				if(!Base.isTaobaoEnabled){
					CustomDialog.Builder buidler = new CustomDialog.Builder(OtherGoodsDetilsActivity.this);
	...
	private void shopping(boolean flag){
				IsIntent.ToWeb1(OtherGoodsDetilsActivity.this, click_url, "商品详情", flag);
	}
}
